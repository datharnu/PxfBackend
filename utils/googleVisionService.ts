...
export class GoogleVisionService {
   ...
   */
  private static likelihoodToScore(likelihood: any): number {
    switch (likelihood) {
      case "VERY_LIKELY":
        return 0.9;
      case "LIKELY":
   ...
   */
  private static getGlassesStatus(face: any): string {
   ...
   */
  private static getGenderFromLandmarks(face: any): string {
