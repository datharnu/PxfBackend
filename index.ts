...
app.use(cors());
app.use(express.json({ limit: "50mb" })); // Increase limit to handle large payloads
app.use(express.urlencoded({ extended: false, limit: "50mb" })); // Increase limit for form data
