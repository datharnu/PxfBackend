...
<body>
  <div class="container">
    ...
    <div class="hero">
      ...
      <a href="${process.env.DOMAIN_URL || "https://pxf.com"}/dashboard" class="cta-btn">Get Started</a>
    </div>
    ...
    <div class="footer">
      ...
      <a href="mailto:${process.env.SUPPORT_EMAIL || "memoriapxfhelp@gmail.com"}" style="color:#2563eb; text-decoration:none;">
