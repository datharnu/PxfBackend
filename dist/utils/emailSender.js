...
exports.sendVerificationRevokedMail = exports.sendAdminWelcomeMessage = exports.sendDeActivationMail = exports.sendActivationMail = exports.sendAgentNotVerifiedMail = exports.sendAgentVerifiedMail = exports.sendPasswordResetCode = exports.sendWelcomeMessage = void 0;
...
const sendWelcomeMessage = ({ sender, recipient, user, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
        subject: "🏡 Welcome to Rentville + RConnect - Your Complete Housing Solution",
        html: `<!DOCTYPE html>
  <html lang="en">
  <head>
    <meta charset="UTF-8">
    ...
    <div class="email-container">
      ...
      <div class="content">
        ...
        <div class="main-cta-container" style="text-align: center; margin: 30px 0;">
          <a href="${process.env.DOMAIN_URL || "https://rconnect.rentville.ng"}/dashboard" class="main-cta" style="display: inline-block; background: #134F2C; color: white !important; text-decoration: none; padding: 14px 28px; border-radius: 4px; font-weight: 600; font-size: 16px;">Get Started Now</a>
        </div>
        
        <p style="text-align: center; font-size: 14px; color: #718096; margin-top: 30px;">
          Need help? Contact us at <a href="mailto:${process.env.SUPPORT_EMAIL || "rentvilleinfo@gmail.com"}" style="color: #134F2C; text-decoration: none;">${process.env.SUPPORT_EMAIL || "rentvilleinfo@gmail.com"}</a>
        </p>
      </div>
    </div>
...
const sendPasswordResetCode = ({ sender, recipient, verificationCode, user, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
...
const sendAgentVerifiedMail = ({ sender, recipient, user, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
...
exports.sendAgentVerifiedMail = sendAgentVerifiedMail;
const sendAgentNotVerifiedMail = ({ sender, recipient, user, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
...
exports.sendAgentNotVerifiedMail = sendAgentNotVerifiedMail;
const sendActivationMail = ({ sender, recipient, user, activatedAt, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
        subject: " Important Update on Your Rentville Account Application",
...
const sendDeActivationMail = ({ sender, recipient, user, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
...
exports.sendDeActivationMail = sendDeActivationMail;
const sendAdminWelcomeMessage = ({ sender, recipient, user, email, password, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
...
exports.sendAdminWelcomeMessage = sendAdminWelcomeMessage;
const sendVerificationRevokedMail = ({ sender, recipient, user, }) => {
    return (0, sendEmail_1.default)({
        from: sender,
        to: recipient,
...
exports.sendVerificationRevokedMail = sendVerificationRevokedMail;
